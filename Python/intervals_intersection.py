...
# O(N + M) time complexity, where N is the length of intervals_a and M is the length of intervals_b, since in the worst case we have to reach the end of both arrays. Regardless, we have to reach the end of at least one of the arrays.
